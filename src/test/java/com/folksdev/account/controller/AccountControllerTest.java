...
class AccountControllerTest {
    ...
    private AccountService service = new AccountService(
            accountRepository, customerService, transactionService, converter);
    ...
    public void testCreateAccount_whenCustomerIdExists_shouldCreateAccountAndReturnAccountDto() throws Exception{
        Customer customer = customerRepository.save(new Customer("Nuray", "Aydin"));
        ...
        this.mockMvc.perform(post("/v1/account")
                ...
                .andExpect(jsonPath("$.customer.name", is("Nuray")))
                .andExpect(jsonPath("$.customer.surname", is("Aydin")))
